package com.wiredbraincoffee.productapiannotation; //
												//I don't want to restart the server everytime the test runs -> I will use Mocks.
...
public class JUnit5ControllerMockTest {
    ...
    @MockBean //i use mockito
    private ProductRepository repository; //In each test method, using mockito I specify what the repository method should return.
