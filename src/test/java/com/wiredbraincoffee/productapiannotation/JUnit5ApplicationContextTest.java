package com.wiredbraincoffee.productapiannotation; //IDIO ME JUnit5ControllerTest, alla: allazei o tropos pou create the webtestclient instance
...
public class JUnit5ApplicationContextTest {
    ...
    void beforeEach() {
        this.client =
                WebTestClient
                        .bindToApplicationContext(context) //Allagh2
                        .configureClient()
                        .baseUrl("/products")
                        .build();
