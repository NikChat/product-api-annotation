package com.wiredbraincoffee.productapiannotation; //ME @WebFluxTest
...
@WebFluxTest(ProductController.class) //Allagh1. It will configure beans with the annotation: @Controller, JsonComponent ... But not Component, Service, Repository beans
public class JUnit5WebFluxTestAnnotationTest {

    @Autowired //@WebFluxTest will autoconfigure a WebTestClient instance
    ...
    @MockBean
    private CommandLineRunner commandLineRunner; //used to insert some initial data
